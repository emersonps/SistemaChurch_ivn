...
<div class="member-form-topbar d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
    <div>
        ...
        <h1 class="h3 mb-0">Novo Banner</h1>
    </div>
    <div class="d-none d-md-flex gap-2">
        <a href="/admin/banners" class="btn btn-outline-secondary rounded-pill fw-semibold px-3">Cancelar</a>
        <button type="submit" form="bannerCreateForm" class="btn btn-dark rounded-pill fw-semibold px-3">Salvar</button>
    </div>
</div>
...
<form action="/admin/banners/create" method="POST" enctype="multipart/form-data" class="app-form-with-bottom-actions" id="bannerCreateForm">
    <?= csrf_field() ?>
    ...
    <div class="member-form-card">
        ...
        <div class="member-form-card-body">
            <div class="row g-3">
                ...
                <div class="col-md-8">
                    <label for="image" class="form-label">Imagem <span class="required-mark">*</span></label>
