...
<div class="member-form-topbar d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
    <div>
        ...
        <h1 class="h3 mb-0">Nova Congregação</h1>
    </div>
    <div class="d-none d-md-flex gap-2">
        <a href="/admin/congregations" class="btn btn-outline-secondary rounded-pill fw-semibold px-3">Cancelar</a>
        <button type="submit" form="congregationCreateForm" class="btn btn-dark rounded-pill fw-semibold px-3">Salvar</button>
    </div>
</div>
...
<div class="row">
<div class="col-lg-8">
<form action="/admin/congregations/create" method="POST" enctype="multipart/form-data" class="app-form-with-bottom-actions" id="congregationCreateForm" autocomplete="off">
    <?= csrf_field() ?>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" name="leader_name" id="leaderNameCreate" list="membersListCreate" placeholder="Digite o nome ou selecione..." autocomplete="off" required>
                    ...
                    <div class="form-text">Selecione um membro da lista ou digite um novo nome. Se selecionar um membro de outra congregação, ele será transferido para esta nova congregação ao salvar.</div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="phone" placeholder="(00) 00000-0000" autocomplete="off" required>
                </div>
                <div class="col-md-6">
        ...
        <div class="member-form-card-body">
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="city" name="city" list="citiesList" autocomplete="off" required>
                    <datalist id="citiesList"></datalist>
                </div>
                <div class="col-md-6">
                    <label class="form-label">Estado <span class="required-mark">*</span></label>
                    <input type="text" class="form-control" id="state" name="state" placeholder="UF" list="statesList" autocomplete="off" required>
        ...
        <div class="member-form-card-body">
            <div id="schedule-container">
                <div class="row g-3 mb-2 schedule-row">
                    ...
                    <div class="col-md-2">
                        <button type="button" class="btn btn-outline-danger btn-sm remove-schedule" disabled><i class="fas fa-trash"></i></button>
                    </div>
                </div>
            </div>
    ...
    <div class="member-summary-box sticky-top" style="top: 1rem; z-index: 10;">
        <div class="member-form-card">
            <div class="member-form-card-body">
                ...
                <div class="summary-value mb-2" id="summaryType">Regular</div>
...
const congForm = document.getElementById('congregationCreateForm');
...
const isHeadquartersInput = document.getElementById('isHeadquartersCreate');
...
function updateCongSummary() {
    ...
    const leaderVal = document.getElementById('leaderNameCreate').value.trim();
    summaryLeader.textContent = leaderVal || '—';
    summaryLeader.classList.toggle('text-muted-value', !leaderVal);
    ...
    summaryLocation.classList.toggle('text-muted-value', !location);
...
document.addEventListener('DOMContentLoaded', updateCongSummary);
updateCongSummary();
</script>
