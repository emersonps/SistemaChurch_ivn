...
<div class="member-form-topbar d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
    ...
    <div class="d-none d-md-flex gap-2">
        ...
        <button type="submit" form="userEditForm" class="btn btn-dark rounded-pill fw-semibold px-3">Salvar</button>
    </div>
</div>
...
<div class="row">
<div class="col-lg-8">
<form action="/admin/users/edit/<?= $user['id'] ?>" method="POST" class="app-form-with-bottom-actions" id="userEditForm">
    <?= csrf_field() ?>
    ...
    <div class="member-summary-box sticky-top" style="top: 1rem; z-index: 10;">
        <div class="member-form-card">
            <div class="member-form-card-body">
                ...
                <div class="summary-value" id="summaryUsername"><?= htmlspecialchars($user['username'] ?: '—') ?></div>
...
<script>
    ...
    function updateSummary() {
        ...
        const requiredFields = [userForm.querySelector('[name="username"]')];
        if (!roleSelect.disabled) requiredFields.push(roleSelect);
