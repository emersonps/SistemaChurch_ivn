...
<div class="member-form-topbar d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
    <div>
        ...
        <h1 class="h3 mb-0">Novo Álbum</h1>
    </div>
    <div class="d-none d-md-flex gap-2">
        <a href="/admin/gallery" class="btn btn-outline-secondary rounded-pill fw-semibold px-3">Cancelar</a>
        <button type="submit" form="albumCreateForm" class="btn btn-dark rounded-pill fw-semibold px-3">Salvar</button>
    </div>
</div>
...
<form action="/admin/gallery/create" method="POST" class="app-form-with-bottom-actions" id="albumCreateForm">
    <?= csrf_field() ?>
