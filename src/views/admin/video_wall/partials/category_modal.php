...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('addCategoryBtn').addEventListener('click', function () {
        ...
        postJson('/admin/video-wall/categories', { name: name }).then(function (data) {
    ...
    list.addEventListener('click', function (event) {
        ...
        if (saveBtn) {
            ...
            postJson('/admin/video-wall/categories/rename/' + id, { name: newName }).then(function (data) {
        ...
        if (deleteBtn) {
            ...
            postJson('/admin/video-wall/categories/delete/' + liToDelete.dataset.id, {}).then(function () {
                var option = Array.prototype.find.call(categorySelect.options, function (opt) {
