...
<head>
    ...
    <title>Senha Criada - <?= htmlspecialchars($siteProfile['alias'] ?? 'IVN') ?></title>
...
<div class="container">
    <div class="card login-card shadow-lg border-0 text-center">
        <div class="card-body p-4">
            ...
            <h4 class="mb-2">Senha criada com sucesso!</h4>
            <p class="text-muted mb-4">Sua conta foi ativada. Agora você já pode fazer login na área do membro.</p>
            <div class="d-grid gap-2">
                <a href="/portal/login" class="btn btn-danger">
