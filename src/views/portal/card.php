                ...
                <div class="d-flex mb-2 pe-1">
                    ...
                    <div>
                        <div class="d-inline-block bg-white px-2 py-1 shadow-sm" style="opacity: 0.95; border-radius: 12px;">
                            ...
                            <div class="fw-bold" style="font-size: 10px; color: #444; max-width: 100px; line-height: 1.1;"><?= mb_convert_case($member['congregation_name'] ?? 'Sede', MB_CASE_TITLE, "UTF-8") ?></div>
                        </div>
                    </div>
                </div>
...
document.getElementById('btnDownload').addEventListener('click', function() {
    generateCardImage(function(canvas) {
        ...
        link.download = 'minha-carteirinha.png';
